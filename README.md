<img src="https://github.com/riley-ad-clark/image-collection/blob/main/incremental-counter-gif.gif">

# Incremental Counter
This is a project that is aimed to see my ability to explain topics related to web development, clearly, and consisely.
